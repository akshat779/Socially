...
import { CalendarIcon, EditIcon, FileTextIcon, HeartIcon, LinkIcon, MapPinIcon, User } from "lucide-react";
import { useState } from "react";
import toast from "react-hot-toast";

type User = NonNullable<Awaited<ReturnType<typeof getProfileByUsername>>>;
type Posts = NonNullable<Awaited<ReturnType<typeof getUserPosts>>>;
...
function ProfilePageClient({isFollowing:initialIsFollowing, likedPosts,posts,user}:ProfilePageClientProps){
    ...
    const formattedDate = format(new Date(user.creatadAt),"MMMM yyyy")
